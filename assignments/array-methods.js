...
// Problem 1
let emailList = [];
runners.forEach(x => emailList.push(x.email))
console.log(emailList)
// Problem 2
let company = [];
company.push(runners.filter(x => x.company_name == 'Mycat'))
console.log(company);
// Problem 3
let firstLettersOfAllCaps = [];
allCapsExceptTheFIrstLetter = allCaps.map(x => x.charAt(0).toLowerCase())
console.log(allCapsExceptTheFIrstLetter)